...
public class Sovellus {
    ...
    private static void kuuluu() {
        ...
        if (kuuluuko) {
            System.out.println(kysLuku + " kuuluuJoukkoon joukkoon ");
        } else {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Komennot ovat lisää(li), poista(p), kuuluuJoukkoon(k), yhdiste(y), erotus(e), leikkaus(le) ja lopetus(quit)(q).");
        ...
        while (true) {
            ...
            if (luettu.equals("lisää") || luettu.equals("li")) {
                ...
                poista();
            } else if (luettu.equalsIgnoreCase("kuuluuJoukkoon") || luettu.equalsIgnoreCase("k")) {
                kuuluu();
                ...
                System.out.println("Komennot ovat lisää(li), poista(p), kuuluuJoukkoon(k), yhdiste(y), erotus(e) ja leikkaus(le).");
            }
            System.out.println("Komennot ovat lisää(li), poista(p), kuuluuJoukkoon(k), yhdiste(y), erotus(e) ja leikkaus(le).");
        }
    }
